...
$docsBase = 'https://github.com/WillDuque01/AULA-VIRTUAL-LTS-HOSTINGER-2025/tree/main';
        ...
        'setup.integrations' => [
            ...
            'cards' => [
                [
                    ...
                    'docs' => $docsBase.'/lms_espanol_blueprint_tecnico_y_plan_de_implementacion_cursor_gpt.md',
                ],
                [
        ...
        'admin.dashboard' => [
            ...
            'cards' => [
                [
                    ...
                    'docs' => $docsBase.'/docs/dataporter_hub.md',
                ],
                [
        ...
        'lessons.player' => [
            ...
            'cards' => [
                [
                    ...
                    'docs' => $docsBase.'/docs/player_signals_playbook.md',
                ],
            ],
        ],
        'courses.builder' => [
        ...
        'dashboard' => [
            'cards' => [
                [
                    ...
                    'docs' => $docsBase.'/credenciales_y_permisos_md_guia_paso_a_paso_para_el_usuario_acompana.md',
                ],
                [
                    ...
                    'docs' => $docsBase.'/docs/planner_operativa_make.md',
                ],
                [
