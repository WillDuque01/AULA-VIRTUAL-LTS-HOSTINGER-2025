...
@section('content')
    ...
    @component('emails.components.panel')
        <h3 style="margin: 0 0 12px 0; color: #38bdf8; font-size: 16px;">{{ $courseTitle }}</h3>
        <p style="margin: 0 0 12px 0; font-size: 14px; line-height: 1.6; color: #cbd5f5;">{!! $courseSummary !!}</p>
